                  ...
                  <div class="documents list">
                     ...
                     <div class="document image-documents">
                        <div class="document-content">
                           ...
                           @php $profile_title2 =  'NIC Picture' @endphp
                           @php $cross2 =  '' @endphp
                           @php $icon2 =  'icon-pencil' @endphp
                           @else
                           @php $path2 = "images/no-img.png"; @endphp
                           @php $profile_title2 =  'No NIC Picture' @endphp
                           @php $cross2 = '
                           <div class="centered">X</div>
                           ' @endphp
                           @php $icon2 =  'fa fa-plus' @endphp
                           @endif
                           @endif
                           <div class="document-profile">
                              <?php echo $cross2;?>
                              ...
                              <div class="document-info">
                                 <p class="document-name mb-0">{{$profile_title2}}</p>
                              </div>
                           </div>
                           <?php 
                              if (env('APP_ENV') == 'local') {
                           ...
                           <div class="line-h-1 h5">
                              <a class="text-success edit-document" href="#" data-toggle="modal" data-target="#NICModal"><i class="<?php echo $icon2;?>"></i></a>                            
                           </div>
                        </div>
                     </div>
