    ...
    <div class="page-body">
        <div class="container-fluid">
            <div class="page-title">
                <div class="row">
                    <div class="col-6">
                        <h3>Create Development Project</h3>
                    </div>
                    <div class="col-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Create Development Project</li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form theme-form">
                                <form method="POST" action="{{route('development_project_submit')}}" id="project-form"
                                      autocomplete="off">
                                    @csrf
                                    <div class="row">
                                        <div class="col-sm-4">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="mb-3">
                                                ...
                                                <select class="js-example-basic-multiple col-sm-12" id="developmenttype"
                                                        name="developmenttype" required>
                                        ...
                                        <div class="col-lg-4">
                                            <div class="mb-3">
                                                ...
                                                <input class="datepicker-here form-control digits @error('project_cost') is-invalid @enderror" id="minMaxExample" readonly placeholder="Select Due Date" name="due_date" type="text" data-language="en"  data-position="bottom right" required>
                                            </div>
                                        </div>
...
{{--                                                </select>--}}
                                        ...
                                        <div class="col-lg-4">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control @error('category') is-invalid @enderror"
                                                       value="{{ old('category') }}" name="category" type="text"
                                                       placeholder="Ex: Website, Mobile App" required/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-4">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control @error('plateform') is-invalid @enderror"
                                                       value="{{ old('plateform') }}" name="plateform" type="text"
                                                       placeholder="Ex: PhP, React js"/>
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <div class="mb-3">
                                                <label>Theme Color</label>
                                                <input class="form-control @error('theme_color') is-invalid @enderror"
                                                       value="{{ old('theme_color') }}" name="theme_color" type="text"
                                                       placeholder="Ex: Red , Black"/>
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <div class="mb-3">
                                                <label>Sample URL</label>
                                                <input class="form-control @error('sample_url') is-invalid @enderror"
                                                       value="{{ old('sample_url') }}" name="sample_url" type="text"
...
{{--                                                            {{$developmentproj->currency_id == $currency->id ? 'selected' : ''}} value="{{$currency->id}}">{{ $currency->currency }}</option>--}}
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                <label>Project Remaining <Amount></Amount></label>
        ...
        $("#multiFileUpload").dropzone({
            ...
            init: function () {
                ...
                let hashedFileName = file.name.hashCode();
                    ...
                    if (obj.filetype == "pdf") {
                        // $("#uploaded-images").append('<a download href="' + url + img + ' class='+ hashedFileName +'"><i class="fa fa-file-pdf-o"></i> Download PDF File</a>');
                        $("#uploaded-images").append('<input type="hidden" name="attachment_path_id[]" value="' + img + '" id='+ hashedFileName +'>')
                    } else if (obj.filetype == "docx") {
                        // $("#uploaded-images").append('<a download href="' + url + img + ' class='+ hashedFileName +'"><i class="fa fa-file-word-o" aria-hidden="true"></i> Download Word File</a>');
                        $("#uploaded-images").append('<input type="hidden" name="attachment_path_id[]" value="' + img + '" id='+ hashedFileName +'>')
                    } else {
                        // $("#uploaded-images").append('<img src="' + url + img + '" class='+ hashedFileName +' > ');
                        $("#uploaded-images").append('<input type="hidden" name="attachment_path_id[]" value="' + img + '" id='+ hashedFileName +'>')
                    }
