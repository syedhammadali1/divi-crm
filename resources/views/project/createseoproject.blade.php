                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Create Seo Project</li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form theme-form">
                                <form method="POST" action="{{route('seo_project_submit')}}" id="project-form"
                                      autocomplete="off">
                                    @csrf
                                    <div class="row">
                                        <div class="col-sm-4">
...
{{--                                                </select>--}}
                                        ...
                                        <div class="col-lg-4">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control @error('competitor_website') is-invalid @enderror"
                                                       value="{{ old('competitor_website') }}" name="competitor_website" type="url"
                                        ...
                                        <div class="col-lg-4">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control @error('products_services') is-invalid @enderror"
                                                       value="{{ old('products_services') }}" name="products_services" type="text"
...
{{--                                                            {{$developmentproj->currency_id == $currency->id ? 'selected' : ''}} value="{{$currency->id}}">{{ $currency->currency }}</option>--}}
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div>
                                            <a class="btn btn-success me-3" id="project-submit"
