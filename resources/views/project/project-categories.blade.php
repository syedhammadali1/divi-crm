    ...
    <div class="page-body">
        ...
        <div class="container-fluid">
            <div class="row project-cards">
                ...
                <div class="col-sm-4">
                    <div class="card">
                        <a href="{{route('viewCategoryProjects.brandid.cateid', ['brandid' => $brand_id , 'cateid' => 'content','sourceId' => $source_id ])}}">
                            <div class="card-body text-center">
                                <img class="proj-icon" alt="logo"
                                     src="{{ asset('images/project-icons/content-creative.png') }}"/>
                                <h5 class="mt-3">Content Writing</h5>
                            </div>
                        </a>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="card">
                        <a href="{{route('viewCategoryProjects.brandid.cateid', ['brandid' =>$brand_id ,  'cateid' => 'design','sourceId' => $source_id ])}}">
                            <div class="card-body text-center">
                                <img class="proj-icon" alt="logo"
                ...
                <div class="col-sm-4">
                    <div class="card">
                        <a href="{{route('viewCategoryProjects.brandid.cateid', ['brandid' =>$brand_id ,  'cateid' => 'Development','sourceId' => $source_id ])}}">
                            <div class="card-body text-center">
                                <img class="proj-icon" alt="logo"
                ...
                <div class="col-sm-4">
                    <div class="card">
                        <a href="{{route('viewCategoryProjects.brandid.cateid', ['brandid' =>$brand_id ,  'cateid' => 'seo','sourceId' => $source_id ])}}">
                            <div class="card-body text-center">
                                <img class="proj-icon" alt="logo"
                ...
                <div class="col-sm-4">
                    <div class="card">
                        <a href="{{route('viewCategoryProjects.brandid.cateid', ['brandid' =>$brand_id ,  'cateid' => 'other','sourceId' => $source_id ])}}">
                            <div class="card-body text-center">
                                <img class="proj-icon" alt="logo"
