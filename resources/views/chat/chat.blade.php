                                    ...
                                    <div class="tab-content" id="myTabContent">
                                        <div class="tab-pane fade show active" id="tab1" role="tabpanel">
                                            ...
                                            <div class="border-top theme-border px-2 py-3 position-relative chat-box">
                                                ...
                                                <input type="text" class="form-control mr-2" name="message" placeholder="Type message here ..." />   
...
<script type="text/javascript">
      ...
      socket.on('message post', function(msg) {  // Receiver
        ...
        if (msg.from_user_id == "{{Auth::user()->id}}") {
          ...
          // console.log(image);
          //var body = '<div class="profile-inner-full-chat"><div class="profile-inner-full-chat-from"><ul><li class="profile-inner-full-chat-from-image"><img src="'+image+'"><span></span></li><li class="profile-inner-full-chat-from-text"><div class="profile-inner-full-chat-from-name"><h1>{{Auth::user()->user_name}}</h1><div class="chat-dropdown-report"></div></div><p>'+msg.message+'<span><img src="'+msg.clock+'">'+ msg.created_at+'</span></p></li></ul></div></div>';
          ...
          // var body = '<div class="profile-inner-full-chat profile-inner-full-chat-right"><div class="profile-inner-full-chat-from"><ul><li class="profile-inner-full-chat-from-image"><img src="'+imagenn+'"><span></span></li><li class="profile-inner-full-chat-from-text"><div class="profile-inner-full-chat-from-name"><h1>'+msg.fromusername+'</h1><div class="chat-dropdown-report"></div></div><p>'+msg.message+'<span><img src="'+msg.clock+'">'+ msg.created_at+'</span></p></li></ul></div></div>';
